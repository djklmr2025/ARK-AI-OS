...
class CommandExecutor:
    ...
    def __init__(self, workspace_root: str = None, timeout: int = 300):
        ...
        self.allowed_commands = {
            ...
            "npx": ["create-react-app", "create-next-app", "@vue/cli", "degit"],
            "node": ["-v", "--version"],
            ...
            # Git
            "git": ["init", "add", "commit", "push", "pull", "status", "log", "clone", "branch", "--version"],
            
            # Firebase
            "firebase": ["init", "deploy", "serve", "login", "logout"],
